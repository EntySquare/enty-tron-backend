...
func (d *Database) SelectCollectTxs(ctx context.Context, txn *sql.Tx) (result int64, err error) {
...
func (d *Database) ListAddressByStatus(ctx context.Context, txn *sql.Tx) (maps []types.Address, err error) {
